...
#include <splash128x64.h> //splash screen image file. Image is in XBM format
...
void demoStart(){
  ...
  oled.drawXBM(splash128x64_bits, splash128x64_width, splash128x64_height, 
              (oled.getWidth() - splash128x64_width) /2, (oled.getHeight() - splash128x64_height) / 2, SSD_COLOR_WHITE);
  oled.display();
